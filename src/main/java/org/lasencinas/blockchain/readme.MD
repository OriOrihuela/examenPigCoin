...
firma de la transacción es válida, utilizando la clave pública de la wallet que envía los
•
...
summarize(index) visualiza una transacción del blockchain situada en la posición
index